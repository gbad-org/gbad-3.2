...
public class CrawlLinkedIn {
	...
	public static void main(String[] args) throws Exception {
		...
		crawleLinkedInPage t1 = new   crawleLinkedInPage(alreadyCrawledMap,urlMap , truthMap, mapProxy);
		new Thread(t1).start();
		
		crawleLinkedInPage t2 = new   crawleLinkedInPage(alreadyCrawledMap,urlMap , truthMap, mapProxy);
		new Thread(t2).start();
				

		crawleLinkedInPage t3 = new   crawleLinkedInPage(alreadyCrawledMap,urlMap , truthMap, mapProxy);
		new Thread(t3).start();
				
		
		crawleLinkedInPage t4 = new   crawleLinkedInPage(alreadyCrawledMap,urlMap , truthMap, mapProxy);
		new Thread(t4).start();
				

		crawleLinkedInPage t5 = new   crawleLinkedInPage(alreadyCrawledMap,urlMap , truthMap, mapProxy);
		new Thread(t5).start();
